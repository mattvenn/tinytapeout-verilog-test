...
set ::env(DESIGN_NAME) scan_wrapper_341457971277988435
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341457971277988435.v \
$::env(DESIGN_DIR)/scan_wrapper_341457971277988435.v"
