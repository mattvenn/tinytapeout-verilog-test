...
set ::env(DESIGN_NAME) scan_wrapper_341360223723717202
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341360223723717202.v \
$::env(DESIGN_DIR)/scan_wrapper_341360223723717202.v"
