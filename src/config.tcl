...
set ::env(DESIGN_NAME) scan_wrapper_340067262721426004
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_340067262721426004.v \
$::env(DESIGN_DIR)/scan_wrapper_340067262721426004.v"
