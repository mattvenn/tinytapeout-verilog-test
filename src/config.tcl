...
set ::env(DESIGN_NAME) scan_wrapper_341431502448362067
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341431502448362067.v \
$::env(DESIGN_DIR)/scan_wrapper_341431502448362067.v"
