...
set ::env(DESIGN_NAME) scan_wrapper_341063825089364563
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341063825089364563.v \
$::env(DESIGN_DIR)/scan_wrapper_341063825089364563.v"
