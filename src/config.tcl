...
set ::env(DESIGN_NAME) scan_wrapper_341590933015364178
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341590933015364178.v \
$::env(DESIGN_DIR)/scan_wrapper_341590933015364178.v"
