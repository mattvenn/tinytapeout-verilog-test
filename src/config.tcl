...
set ::env(DESIGN_NAME) scan_wrapper_341446083683025490
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341446083683025490.v \
$::env(DESIGN_DIR)/scan_wrapper_341446083683025490.v"
