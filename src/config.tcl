...
set ::env(DESIGN_NAME) scan_wrapper_341353780122485332
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341353780122485332.v \
$::env(DESIGN_DIR)/scan_wrapper_341353780122485332.v"
