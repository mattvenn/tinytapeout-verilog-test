...
set ::env(DESIGN_NAME) scan_wrapper_341520747710120530
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341520747710120530.v \
$::env(DESIGN_DIR)/scan_wrapper_341520747710120530.v"
