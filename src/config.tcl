...
set ::env(DESIGN_NAME) scan_wrapper_341464767397888596
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341464767397888596.v \
$::env(DESIGN_DIR)/scan_wrapper_341464767397888596.v"
