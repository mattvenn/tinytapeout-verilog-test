...
WOKWI_PROJECT_ID=341063825089364563

fetch:
# HACK: we don't need to fetch this as we have our own verilog source, manually created: src/user_module_341063825089364563.v
