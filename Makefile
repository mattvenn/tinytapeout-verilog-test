...
WOKWI_PROJECT_ID=341360223723717202

fetch:
# HACK: we don't need to fetch this as we have our own verilog source, manually created: src/user_module_341360223723717202.v
